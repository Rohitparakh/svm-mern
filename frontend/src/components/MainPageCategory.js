...
function MainPageCategory() {
  return (
    <div className="relative" id="services">
      ...
      <div className="px-4 pb-4 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:pb-20 relative">
        <div className="flex flex-col md:flex-row  md:gap-8 ">
          <div className="bg-black  rounded-xl flex flex-col justify-center items-center">
            <img
              src="https://source.unsplash.com/zXCDDLA49c8"
              alt=""
              srcset=""
          ...
          <div>
            <div className="bg-black  rounded-xl flex flex-col justify-center items-center mt-8  md:mt-0">
              <img
                src="https://source.unsplash.com/dlxLGIy-2VU"
                alt=""
                srcset=""
                className="w-full"
              />
            ...
            <div className="bg-black rounded-xl mt-8 flex flex-col justify-center items-center">
              <img
                src="https://source.unsplash.com/BZybQC-zZwQ"
                alt=""
                srcset=""
                className="w-full"
              />
          ...
          <div>
            <div className="bg-black  rounded-xl flex flex-col justify-center items-center mt-8 md:mt-0">
              <img
                src="https://source.unsplash.com/EhTcC9sYXsw"
                alt=""
                srcset=""
                className="w-full"
              />
            ...
            <div className="bg-black  rounded-xl mt-8 flex flex-col justify-center items-center">
              <img
                src="https://source.unsplash.com/Fh3Dtg6QX4Q"
                alt=""
                srcset=""
                className="w-full"
              />
